...
int x[8] = {70, 170, 170, 70, 50, 150, 150, 50};
int y[8] = {120, 120, 70, 70, 100, 100, 50, 50};
int z[8] = {50, 50, 50, 50, 200, 200, 200, 200};

void init()
{
	glClearColor(1.0, 1.0, 1.0, 1.0);
  	glMatrixMode(GL_PROJECTION);
	glOrtho(-1920, 1080,-1920, 1080, -1920, 1080);
}
